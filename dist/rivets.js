...
// license: MIT
(function() {
  var Rivets, bindMethod, trim, unbindMethod, _ref,
  ...
  Rivets.Util.trim = trim = function(str) {
  ...
  Rivets.binders['class-*'] = function(el, value) {
    ...
    if (!value === (elClass.indexOf(" " + this.args[0] + " ") !== -1)) {
      return el.className = value ? "" + el.className + " " + this.args[0] : trim(elClass.replace(" " + this.args[0] + " ", ' '));
    }
  };
